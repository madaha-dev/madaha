use crate::midi::effects::default_data::xg_variation_data;
use crate::midi::effects::{interface::EffectType, variation_type::XGVariationType};
use crate::midi::errors::MidiError;
use crate::midi::ram::MemoryAddr;
use crate::midi::ram::interface::Memory;
use crate::midi::ram::yamaha::effects::interface::EffectRAM;
