...
use crate::midi::ram::{MemoryAddr, RAM, interface::Memory};
...
impl Controller {
    ...
    pub fn get(&self, id: u8, ram: &RAM, cc: u8) -> Option<u8> {
    ...
    pub fn set(
        ...
        let mp = ram.xg.multi_part[id as usize];
        (mp.rcv_switches.rcv_control_change != 0)
            .then(|| {
